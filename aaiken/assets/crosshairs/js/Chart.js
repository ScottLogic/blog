define([
    ...
    var data = new MockData(0.1, 0.1, 100, 50, function (moment) {
        ...
        .generateOHLC(new Date(2014, 7, 1), new Date(2014, 8, 1));
    ...
    var crosshairs = sl.series.crosshairs()
        ...
        .yScale(yScale)
        .yValue('close')
        .formatX(function(data) { return d3.format('.1f')(data.close); })
        .formatY(function(data) { return d3.time.format('%b %e')(data.date); });
