...
# The websites are useful, but they only go so far
...
# Features, bugs and documentation dominate
...
# “Good first issues” are not all alike
...
# Implementation hints are really helpful
...
# Feedback is important even if you don’t get anywhere
