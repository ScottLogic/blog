---
title: The problem(s) with image accessbility
date: 2025-04-17 00:00:00 Z
categories:
- Tech
author: osharon
layout: default_post
...
5. `<img src="/assets/images/hero-headline.png" alt="Welcome to our eCommerce store!">` - Using images instead of plain text means it cannot be read by screen readers and search engines. That's an extra additional 7 years of bad luck.
...
11. `<img src="https://placehold.co/600x400" class="tbd">` - And finally, it's not an accessibilty issue, but it's worth setting yourself a reminder to replace the placeholder images with actual images before publishing your website
