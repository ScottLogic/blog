...
- Choosing an [eco-friendly search engine](https://www.choose-greener.com/eco-friendly-search-engines/) that offsets or minimise its carbon footprint
...
- Questioning the need for AI support. When using AI tools, consult our [guide](https://www.techcarbonstandard.org/guides/reduce-ai-emissions), which contains information on prompt engineering and other strategies to minimise emissions. 
