---
title: NoJS 4 - Pure CSS hackery with AI
date: 2026-09-29 00:00:00 Z
categories:
- Tech
author: garora
layout: default_post
...
<p><img src="{{ site.baseurl }}/garora/assets/noJs3/gemini.png" alt="gemini failing to create flappy bird without JS" title="gemini failing to create flappy bird without JS" width="500" class="alignnone size-full wp-image-95" /></p> It is very well known at this point that a good harness works wonders when using an AI. A harness is simply the scaffolding, tools and instructions that the AI is used with. So the natural question is, can I make a harness for an AI to improve its hacking skills?

## Plan
What better way to train an AI, than to use an AI? So I pointed copilot at my blog posts and instructed it to extract all the hacks but leave behind context. This means that only the core "tricks" were taken not broad structures like "Here is how you build a calculator". From this it made some [skills](https://agentskills.io/home). The skills required a bit of manual tweaking. After this, with fresh copilot sessions, I tested the AI's ability to do CSS hackery, both with and without the skills. In particular I tested both Claude Opus and Claude Sonnet, this is because I wanted to have a lower model succeed where a higher one failed.
...
<object
  ...
  title="First attempt by Claude Opus at a CSS-only calculator, with several flaws"
  width="500"
  height="480"></object>
...
<object
  ...
  title="Improved CSS-only calculator from Claude Opus after feedback, still lacking division"
  width="500"
  height="480"></object>
...
<object
  ...
  title="CSS-only calculator built by Claude Opus using the CSS hackery skill harness"
  width="500"
  height="480"></object>
...
<object
  ...
  title="First attempt by Claude Opus at a CSS-only scrolling jump game, with many flaws"
  width="500"
  height="480"></object>
...
<object
  ...
  title="Polished jump game from Claude Opus that secretly cheated by using JavaScript"
  width="500"
  height="480"></object>
...
<object
  ...
  title="CSS-only jump game built by Claude Sonnet using the harness, functional but rough"
  width="520"
  height="480"></object>
...
<object
  ...
  title="CSS-only calculator built by Fable without any harness, far more polished than earlier attempts"
  width="500"
  height="650"></object>
...
<object
  ...
  title="CSS-only jump game built by Fable without any harness, improved through manual feedback"
  width="900"
  height="500"></object>
