...
The adoption and drive to use AI must also come with environmental considerations. Whilst AI could provide economic benefits and boost productivity, an important question remains regarding when it is appropriate to use. There is gradually improving public awareness that [generating an action figure of yourself comes at an environmental cost](https://www.bbc.co.uk/news/articles/c5yg690e9eno). As this public concern grows, as will the AI adoption by businesses meet further resistance from employees and end-users.
