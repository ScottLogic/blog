...
Often, leadership and agility are discussed as separate concerns. In this post, I argue that they are not merely related but inseparably intertwined. Agility is a mindset rather than a process, and while teams may adopt agile frameworks, follow principles and genuinely want to work in an agile way, they will never truly succeed unless leaders have the appetite and courage to empower them.

![detail scale]({{site.baseurl}}/dogle/assets/agile-leadership/team1.jpg)
...
The goals of this approach — agility and tempo — are exactly the same goals that many software teams strive for, and, as in software, this approach has been hard won through experience and situational requirements.

![detail scale]({{site.baseurl}}/dogle/assets/agile-leadership/militaryplan.jpg)

In the years following the Second World War, the conflicts in which the British Army has been engaged have changed notably. Rather than fighting wars against nation-states, the British Army has increasingly been involved in non-standard engagements such as counter-insurgency and peace-keeping operations, examples of which include conflicts in Northern Ireland, Iraq and Afghanistan. One of the common themes of these engagements has been the tendency for situations on the ground to escalate rapidly and without warning, and often to just as quickly dissipate. This rapid change in the situation on the ground has meant it is rarely practical or even possible for communications to be sent back to senior commanders and for orders to be relayed quickly enough to keep up with changes. Ultimately, this means that junior leaders are often left to make critical leadership decisions under their own initiative as the situation evolves. This has led to a change in leadership style overall, moving away from commanders keeping tight control over the execution of a plan and towards an approach where commanders instead lay out the mission and the boundaries to operate within, leaving the implementation up to more junior leaders. This approach gives those junior leaders the flexibility and freedom to make decisions as they see fit within the confines of the parameters set out and in line with the mission, even contravening direct orders should they feel it necessary in the wider context of the mission.

While the context is of course different, similar problems exist in software development. The requirement to facilitate quick decision-making in order to respond quickly and effectively to ever-evolving, and often ill-defined, situations has driven what we know today as agile development. Central to this approach is the need to empower leaders on the ground to make decisions based on the current situation without the need to involve senior management directly in each case and without fear of reprisal or reprimand for making autonomous decisions. Agile development is about moving quickly and responding to change, to do that effectively, leadership needs to support this goal. In the same way we struggle to be agile within rigid processes, we also struggle to be agile if the leaders at the top do not empower subordinates via delegation of command.
...
No conversation on teams, trust and leadership is complete without considering communication. Communication is, as in many areas, essential to this approach. A leader's ability to enable a Mission Command style of leadership requires clear lines of communication both up and down the chain of command:
