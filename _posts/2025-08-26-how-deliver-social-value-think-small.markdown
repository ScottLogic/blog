---
title: How to deliver social value? Think small.
date: 2025-08-26 12:19:00 Z
categories:
- Delivery
tags:
- public sector
...
Through the Social Value Model, the government aims to achieve value for money by ensuring that its investments contribute to a wider range of policy goals. The Government Commercial Function’s [Social Value Model guidance](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/940826/Social-Value-Model-Edn-1.1-3-Dec-20.pdf) sets out the model’s five key themes, each with specific policy outcomes:

1. **COVID-19 Recovery** – Supporting communities and businesses to recover.

2. **Tackling Economic Inequality** – Creating jobs, skills, and resilient supply chains.

3. **Fighting Climate Change** – Delivering environmental benefits and sustainability.

4. **Equal Opportunity** – Reducing inequalities, especially for disabled people and underrepresented groups.

5. **Wellbeing** – Improving physical and mental health and community integration.
...
In reality, this is not happening. As our CEO Steve Foreshew-Cain explained [in this blog post](https://blog.scottlogic.com/2024/06/04/we-need-bold-and-better-govtech-not-big-it.html), government procurement has taken a backwards step in recent years. Contracts are being awarded to the big IT consultancies, regardless of the proportionately big risks in that approach – not to mention all the missed opportunities for agility and innovation. In this context, support for SMEs is narrowed down to the government’s ITTs encouraging the big suppliers to provide subcontracting opportunities, which stymies the potential for SMEs to grow and flourish.
...
Scott Logic is a purpose-driven company, demonstrated by [our B Corp Certification](https://www.scottlogic.com/news/scott-logic-becomes-certified-b-corp), and there are many other relatively small companies like us that are similarly committed to delivering social value. We’re an untapped resource that’s crying out to be tapped.
