...
```gherkin 
Given the customer has 1 item in “BasketItemCount” 
When they click “Checkout” 
And they select “Collect” from “DeliveryInstuctions” 
Then “Pay on Collection” should be available from “PaymentOption” 
```
< <span style="color: green;">Good</span> >
```gherkin  
Given the customer has 1 item in their basket 
And they have chosen to collect their order 
...
Scenario: User purchases a product 
  ...
  And the user has selected the desired product category 
  And the user has filtered the products by price 
  And the user has applied a discount code 
  When the user adds the product to the cart 
  And the user proceeds to checkout 
  Then the user should see the order summary 
  And the user should confirm the purchase 
```
< <span style="color: green;">Good</span> >
```gherkin 
Scenario: User purchases a product 
  ...
  When the user adds the product to the cart 
  And the user proceeds to checkout 
  Then the user should confirm the purchase 
```
< <span style="color: blue;">Note</span> >  
