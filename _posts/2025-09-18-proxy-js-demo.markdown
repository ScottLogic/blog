...
​~~~javascript
const data = {};
const state = new Proxy(data, { set(target, prop, value) { return (target[prop] = value * 2); } });
state.value = 8;
...
We can also add listeners (`[effect](https://angular.dev/guide/signals#effects)` in the world of angular) so whenever a value changes, something else will be triggered.
function State(initial = {}) {
...
Here You can see a demo of this proxy-based State here
https://codepen.io/odedshr/pen/GgpayPR
