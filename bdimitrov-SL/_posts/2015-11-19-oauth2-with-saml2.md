...
layout: default_post
summary: >-
  There aren't many examples of OAuth2 working with a SAML 2.0 as an
  authentication method on the Internet. The purpose of this post is to provide
  a simple implementation of these two technologies working together.
categories:
  - Tech
tags:
  - Security
